...
Po wejściu na stronę, użytkownik zobaczy mapę, oraz jej lokacje (wymaga dostępu do lokalizacji na urządzeniu). 
Od tego momentu, lokacje w które użytkownik odwiedził zostaną oznaczone, jednakże w celu zapisania swoich postępów, użytkownik musi zarejestrować się i zalogować na stronie. Wszystkie odwiedzone lokacje zostaną zapisane w profilu użytkownika. 
